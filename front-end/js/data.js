...
//                 if (classes[x].Distribution == distribution) {
...
// }
   /* department = $("#department").val();
    ...
    $("#classForm :input").change(function() {
    ...
    if (count == 0){
        ...
        keyword = $("#keyword").val();
        instructor = $("#instructor").val();
        if (distribution != '--') changeInForm = 'distribution'
        else if (department != '') changeInForm = 'department'
        else if (term != '')changeInForm = 'term'
    }
    count ++;
